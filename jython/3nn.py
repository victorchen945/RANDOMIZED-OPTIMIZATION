...
INPUT_FILE = os.path.join("..", "src", "opt", "test", "student.txt")
...
def RO():
    ...
    oa.append(SimulatedAnnealing(1E11, .29, nnop[1]))
    ...
    for i, name in enumerate(oa_names):
        ...
        correctness.append(float(correct)/(correct+incorrect)*100.0)
        traintime.append(training_time)
        testtime.append(testing_time)
        
    print results
    return (correctness,traintime,testtime)
...
for i in range(iter):
    result=RO()
    score0.append(result[0][0])
    score1.append(result[0][1])
    score2.append(result[0][2])
    traintime0.append(result[1][0])
    traintime1.append(result[1][1])
    traintime2.append(result[1][2])
    testtime0.append(result[2][0])
    testtime1.append(result[2][1])
    testtime2.append(result[2][2])
    
with open("rodata.csv",'wb') as csvfile:
    rowriter=csv.writer(csvfile)
    rowriter.writerows([score0,traintime0,testtime0,score1,traintime1,testtime1,score2,traintime2,testtime2])
